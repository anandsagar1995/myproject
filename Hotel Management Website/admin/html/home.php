...
<head>
    ...
    <!-- Morris Chart Styles-->
    <link href="../css/js/morris-0.4.3.min.css" rel="stylesheet" />
    <!-- Custom Styles-->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                       <!-- <li><a href="usersetting.php"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        ...
                        <li><a href="adminsignup.php"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                                ...
                                <table class="table">
									...
									{	
										...
										if($co=="Not Confirm")
										{
											echo"<tr>
												<th>".$trow['id']."</th>
												<th>".$trow['title']." ".$trow['firstname']."</th>
												<th>".$trow['email']."</th>
