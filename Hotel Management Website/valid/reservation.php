...
session_start();
header('location:../html/reserve.php');
...
if($num == 1){
    ...
    $qy = " INSERT INTO `reservation` (`title`, `firstname`, `lastname`, `email`, `phone`, `nationality`, `roomtype`, `bedtype`, `totalroom`, `meal`, `checkin`, `checkout`,`stat`) VALUES ('$title', '$firstname', '$lastname', '$email', '$phone', '$nationality', '$roomtype', '$bedtype', '$totalroom', '$meal', '$checkin', '$checkout','$new');" ;
    mysqli_query($con, $qy);
